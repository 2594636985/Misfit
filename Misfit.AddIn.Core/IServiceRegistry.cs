...
namespace Misfit.AddIn.Core
{
    public interface IServiceRegistry
    {
	     ...
	     */
        void PublishService(IPluginContext context, IServiceRegistration serviceRegistration);
         ...
         */
        void UnpublishService(IPluginContext context, IServiceRegistration serviceRegistration);
         ...
         */
        void UnpublishServices(IPluginContext context);
         ...
         * exist.
         */
        IServiceReference[] LookupServiceReferences(IPluginContext context);
    }
}
