...
namespace Misfit.AddIn.Core
{
    public class ServiceRegistry : IServiceRegistry
    {
        ...
        protected Dictionary<IPluginContext, List<IServiceRegistration>> publishedServicesByContext;
        ...
        public void Initialize()
        {
            ...
            publishedServicesByContext = new Dictionary<IPluginContext, List<IServiceRegistration>>();
        }

        #region IServiceRegistry Members

        public void PublishService(IPluginContext context, IServiceRegistration serviceRegistration)
        {
        ...
        public void UnpublishService(IPluginContext context, IServiceRegistration serviceRegistration)
        {
        ...
        public void UnpublishServices(IPluginContext context)
        {
        ...
        public IServiceReference[] LookupServiceReferences(IPluginContext context)
        {
            int size;
