...
using Misfit.Desktop.Toolkit.Windows.Media;
using System;
...
namespace Misfit.Desktop.Toolkit.Windows.Navigation
{
    /// <summary>
        ...
        : ILinkNavigator
    {
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            else
            {
                ...
                if (source == null)
                {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, Misfit.Desktop.Toolkit.Resources.NavigationFailedSourceNotSpecified, uri));
                }
                ...
                if (frame == null)
                {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, Misfit.Desktop.Toolkit.Resources.NavigationFailedFrameNotFound, uri, parameter));
                }
