...
using Misfit.Plugins.Injection.Activation.Components;
...
namespace Misfit.Plugins.Injection
{
    ...
    /// 用于建设容器的类
    /// </summary>
    public class MisfitContainerBuilder : IPluginContainerBuilder
    {
        private readonly IPluginContainer _bootStrappingContainer;
        ...
        public IRegistrationBuilder Register<TContract>(Func<IPluginContainer, TContract> activatorFunction)
        {
