...
namespace MisfitThemes.Navigation
{
    /// <summary>
        ...
        : ILinkNavigator
    {
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            else
            {
                ...
                if (source == null)
                {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, MisfitThemes.Resources.NavigationFailedSourceNotSpecified, uri));
                }
                ...
                if (frame == null)
                {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, MisfitThemes.Resources.NavigationFailedFrameNotFound, uri, parameter));
                }
